...
typedef enum {
    IO_OUTch_LED_DS0 = 0,  ///< DS0 (PB5) - 低电平点亮
    IO_OUTch_LED_DS1,      ///< DS1 (PE5) - 低电平点亮

    IO_OUTch_Max            ///< 引脚总数
} io_out_ch_t;
#define LEDNUM  IO_OUTch_Max
typedef enum {
    IO_INch_KEY_UP = 0,    ///< WK_UP (PA0) - 高电平有效
    IO_INch_KEY_RIGHT,     ///< KEY0  (PE4) - 低电平有效 (right)
    IO_INch_KEY_DOWN,      ///< KEY1  (PE3) - 低电平有效 (down)
    IO_INch_KEY_LEFT,      ///< KEY2  (PE2) - 低电平有效 (left)
