...
static void modefunc_Lastfunc(void){
    unsigned char key_flag = keyXvalread(KEY_CH_trig, KEY_VAL_FLAG);
    unsigned char key_pressing = keyXvalread(KEY_CH_trig, KEY_VAL_PRESS);
    USB_HID_Mouse_Func(key_flag, key_pressing);
}
